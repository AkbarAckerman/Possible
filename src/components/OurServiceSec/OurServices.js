        ...
        <div className='about' id='AboutUs'>
            <div className='container'>  
                ...
                <div className='images'>
                    <div><img className='side_image' src="/assets/laptop_pic_one.svg" alt=''></img></div>
                    <div><img className='center_image' src="/assets/laptop_pic_two.svg" alt=''></img></div>
                    <div><img className='side_image' src="/assets/laptop_pic_three.svg" alt=''></img></div>
                </div>
                <div className='OurServices-footer'>
                    <div className='icon-texts'>
                        <div><img className='red_icons' src="/assets/red_icon_one.svg" alt=''></img></div>
                        <div>
                    ...
                    <div className='icon-texts'>
                        <div><img className='red_icons' src="/assets/red_icon_two.svg" alt=''></img></div>
                        <div>
                    ...
                    <div className='icon-texts'>
                        <div><img className='red_icons' src="/assets/red_icon_three.svg" alt=''></img></div>
                        <div>
